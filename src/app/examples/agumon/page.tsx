...
function ScanGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    ...
    >
      {/* Back button */}
      <Link href="/examples" className="absolute top-6 left-6 flex items-center gap-2 text-white/50 hover:text-white transition z-10">
        <ArrowLeft size={20} />
    ...
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-black">
      ...
      >
        <div className="absolute inset-0 bg-black">
          <img 
            src="/images/agumon/nike_air_force_1_cinematic_white_on_black.png" 
            alt="AF1 Reality" 
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto mb-20 md:mb-32">
        ...
        >
          <div className="relative aspect-[4/5] overflow-hidden group border border-white/10">
            ...
            <img 
              src="/images/agumon/urban_concrete_basketball_court_night_texture.png" 
              alt="NYC Court" 
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
        ...
        >
          <div className="relative aspect-[4/5] overflow-hidden group border border-white/10">
            ...
            <img 
              src="/images/agumon/leather_stitching_macro_craft.png" 
              alt="Leather Detail" 
              className="w-full h-full object-cover grayscale contrast-125 transition-transform duration-[2s] group-hover:scale-110"
            />
